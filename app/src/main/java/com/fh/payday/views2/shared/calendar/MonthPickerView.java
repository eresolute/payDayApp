package com.fh.payday.views2.shared.calendar;
    ...
    */
        ...
        int actionButtonColor = a.getColor(R.styleable.monthPickerDialog_dialogActionButtonColor, 0);
         ...
         if (monthFontColorNormal == 0) {
             ...
             monthFontColorNormal = getResources().getColor(R.color.textColor);
           ...
           /* if (Build.VERSION.SDK_INT >= Build.VERSION_CODES.LOLLIPOP) {
            ...
            /*monthFontColorNormal = context.getTheme().resolveAttribute(
                    android.R.attr.textColorPrimary, outValue, true) ? outValue.data : getResources().getColor(R.color.textColor);*/

        }

        if (monthFontColorSelected == 0) {
            monthFontColorSelected = getResources().getColor(R.color.white);
        }

        if (monthFontColorDisabled == 0) {
            monthFontColorDisabled = getResources().getColor(R.color.textBlackDisabled);

        }
        if (_headerFontColorNormal == 0) {
            _headerFontColorNormal = getResources().getColor(R.color.textWhiteDisabled);
        }
        if (_headerFontColorSelected == 0) {
            _headerFontColorSelected = getResources().getColor(R.color.white);
        }
        if (headerTitleColor == 0) {
            headerTitleColor = getResources().getColor(R.color.white);
        }
        if (monthBgColor == 0) {
            monthBgColor = getResources().getColor(R.color.white);
        }
        ...
        _monthViewAdapter.setOnDaySelectedListener((view, selectedMonth) -> {
