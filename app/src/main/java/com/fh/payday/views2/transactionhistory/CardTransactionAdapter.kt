...
class CardTransactionAdapter @JvmOverloads constructor(
        private val items: List<Transactions>,
        private val action: (Transactions) -> Unit = {}
) : RecyclerView.Adapter<CardTransactionAdapter.ViewHolder>() {
    ...
    class ViewHolder(private val itemsView: View) : RecyclerView.ViewHolder(itemsView) {
        ...
        private var ivCreDeb: TextView = itemsView.findViewById(R.id.iv_arrow)

        fun bindTo(item: Transactions, listener: View.OnClickListener) {
